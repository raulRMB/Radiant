...
public class PFSDK : ModuleRules
{
    // list every library you plan to use here
    private List<string> LibraryNames = new List<string>()
    {
        "PlayFabMultiplayerWin"
    };

    public PFSDK(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        // SDK relies on certain identifiers being undefined, so this produces warnings
        ...
        //PublicDefinitions.Add("PFMULTIPLAYER_API_ATTRIBUTES");
